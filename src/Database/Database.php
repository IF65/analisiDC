    ...
    class Database {
        ...
        public function createDatabase($db) {
        	try {
                    ...
                    // archivi
                    // ----------------------------------------------------------
                    $this->pdo->exec("create database if not exists `archivi`;")
                    ...
                    $sql = "CREATE TABLE IF NOT EXISTS `archivi`.`articox2` (
                        ...
                        $sql = "CREATE TABLE IF NOT EXISTS `archivi`.`barartx2` (
                            ...
                            $this->pdo->exec($sql) or die(print_r($this->pdo->errorInfo(), true));
                    // dc
                    // ----------------------------------------------------------
                    $this->pdo->exec("create database if not exists `dc`;")
                            or die(print_r($this->pdo->errorInfo(), true));
                    ...
                    // dimensioni
                    // ----------------------------------------------------------
                    $this->pdo->exec("create database if not exists `dimensioni`;")
                            or die(print_r($this->pdo->errorInfo(), true));
